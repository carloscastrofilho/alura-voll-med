const secoes = [
    ...
    },
    {
        ...
        inputTexto: [],
        inputCheck: [
            { id: 1, value: 'Santa Casa Taquaritinga', placeholder: 'Digite seu cep do seu domicilio' },
            { id: 2, value: 'unimed', placeholder: 'Insira seu endereço' },                
            { id: 2, value: 'Bradesco', placeholder: 'Insira seu endereço' },                
            { id: 2, value: 'Amil', placeholder: 'Insira seu endereço' },                
            { id: 2, value: 'Biosaúde', placeholder: 'Insira seu endereço' },                
            { id: 2, value: 'Biovida', placeholder: 'Insira seu endereço' },                
            { id: 2, value: 'São Francisco', placeholder: 'Insira seu endereço' },                
            { id: 2, value: 'Outros', placeholder: 'Insira seu endereço' },                
            { id: 2, value: 'Não tenho Plano', placeholder: 'Insira seu endereço' },                
            // { id: 3, label: 'numero', placeholder: 'insira o numero ' },
            // { id: 4, label: 'Complemento', placeholder: 'insira o seu complemento' },
            // { id: 5, label: 'Telefone', placeholder: '(00) 00000-0000' },
        ]
